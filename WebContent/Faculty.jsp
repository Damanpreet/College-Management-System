...
<%
	...
	<div id="options" style="padding-right: 20px;">
		<img alt="lib" src="images/books.jpg" width="60px" height="35px">&nbsp;&nbsp;<a href="LibraryFaculty.jsp">Visit Library</a><br><br>
		<%
			out.println("<img alt='myprofile' src='images/myprofile.jpg' width='60px' height='35px'>&nbsp;&nbsp;<a href='FacultyProfileServlet?email_id="+maiLid+"'> My Profile </a>");
		%><br><br>
		<img alt="Notice" src="images/notices.jpg" width="60px" height="35px">&nbsp;&nbsp;<a href="ViewFacultyNotice">View Notice</a><br><br>
	</div><br><br>
