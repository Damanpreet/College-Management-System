...
<div id="templatemo_contain">
		...
		<form action="AddStudentServlet" onsubmit="return funcSubmit(this)" name="reg" style="padding-left: 80px;">
			Name: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="text" name="fname" required> - <input type="text" name="mname" required> - <input type="text" name="lname"><br><br>
			
			Date of Birth: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="Number" name="dob_d" max="31" min="1" step="1" required> - <input type="Number" name="dob_m" max="12" min="1" step="1" required> - <input type="Number" name="dob_y" max="2010" min="1984" step="1" required><br><br>
			
			Age: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="Number" name="age" max="30" min="17" step="1" required><br><br>
			...
			Session: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="number" name="session_id1" max="2015" min="1999" step="1" required> -
	  				<input type="number" name="session_id2" max="2019" min="2002" step="1" required><br><br>
			...
			Class10 Percentage: &nbsp;  
					<input type="float" name="perc10" required><br><br>
			
			Class12 Percentage:  &nbsp;   
					<input type="float" name="perc12" required><br><br>
