			...
			<%
				ArrayList<Faculty> facultyList = (ArrayList<Faculty>) request.getAttribute("FACULTY_LIST");
							for(Faculty fl:facultyList){
								out.println("<tr><td>"+fl.getFname()+" "+fl.getMname()+" "+fl.getLname()+"</td><td>"+fl.getDob_d()+"-"+fl.getDob_m()+"-"+fl.getDob_y()+"</td><td>"+fl.getAge()+"</td><td>"+fl.getGender()+"</td><td>"+fl.getPhno()+"</td><td>"+fl.getAddress()+"</td><td>"+fl.getPin()+"</td><td>"+fl.getDeptt()+"</td><td>"+fl.getEmail_id()+"</td><td>"+fl.getEduc()+"</td><td><a href='DeleteFacultyServlet?email_id="+fl.getEmail_id()+"'><img src='del.png'></a></td></tr>");
							}
			%>
		</table><br><br>
